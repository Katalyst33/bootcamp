<template>
    <div id="app">
        <div class="columns is-mobile mt-5 has-text-left">
                ...
                <div class="px-4 py-4 mx-0 mx-sm-5 has-background-white">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input v-model="review.data.title" class="input" type="text" placeholder="Review Title">
                            </div>
                        </div>
                        ...
                        <button @click="addReview" class="button is-primary">Submit Review</button>
                    </div>
                </div>
